														...
														<tr>
															...
															<c:url var="updateCategoryleUrl" value="/nhan-vien-quan-tri/hang-san-xuat/danh-sach/chinh-sua">
																...
																<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
																   title="Cập nhật hãng sản xuất" href="${updateCategoryleUrl}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
																</a>
															</td>
														</tr>
													</c:forEach>
		    ...
		    function deleteNew(data) {
		        $.ajax({
		            ...
		            success: function (result) {
		                window.location.href = "${categoryURL}?page=1&limit=4&message=delete_success";
		            },
