...
<body>
	<form action="<c:url value='/danh-sach-xe-may-theo-hang-san-xuat'/>" id="formSubmit"
		method="GET">
		  <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url('https://wallpaperset.com/w/full/4/f/0/104285.jpg');">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url('https://wallpaperset.com/w/full/6/9/9/104121.jpg');">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url('https://wallpaperset.com/w/full/1/c/6/104033.jpg');">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
        ...
        <section class="top_catagory_area d-md-flex clearfix">
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url('https://wallpaperset.com/w/full/1/2/4/104191.jpg');">
            ...
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url('https://wallpaperset.com/w/full/d/6/e/104379.jpg');">
                <div class="catagory-content">
	                ...
	                <c:forEach var="item" items="${model.listResult}">
	                    ...
	                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.2s">
	                       ...
	                       <div class="product-img">
	                            <a href="${findDetailMotocrycleById}"><img style="width: 400px; height: 250px;" src='<c:url value="/resources/images/${item.thumbnail}"/>' alt=""></a>
	                        </div>
	                        <!-- Product Description -->
	                        ...
	                        <h3>${item.name}</h3>
	                            <h4 class="product-price">
									...
									<small class="text-muted">đ</small></h4>
	                            <p>${item.description}</p>
	                            <!-- Add to Cart -->
	                            <a href='<c:url value="/mua-hang?id=${item.id}"/>' class="add-to-cart-btn">ADD TO CART</a>
	                        </div>
	                    </div>
                    </c:forEach>
                </div>
        ...
        <!-- ****** New Arrivals Area End ****** -->
          <!-- ****** Offer Area Start ****** -->
        <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url('https://wallpaperset.com/w/full/0/f/b/104269.jpg');">
            <div class="container h-100">
