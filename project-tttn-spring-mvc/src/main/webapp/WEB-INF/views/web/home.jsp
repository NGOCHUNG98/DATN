...
<body>
	<%-- 	<div class="row">
		<c:forEach var="item" items="${model.listResult}">
			...
			<div class="col-lg-4 col-md-6 mb-4 img-align">
				<div class="card h-100">
					<a href="${findDetailMotocrycleById}"> <img
						class="card-img-top thumnail-image"
						src='<c:url value="/resources/images/${item.thumbnail}"/>' />
					</a>
					<div class="card-body">
						<h4 class="card-title">
							<a href="${findDetailMotocrycleById}">${item.name}</a>
						</h4>
